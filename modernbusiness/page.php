...
<header class="bg-dark py-5">
	<div class="container px-5">
		<div class="row gx-5 align-items-center justify-content-center">
			...
			<?php if (pods_image_url(pods_field('right_image'))) : ?><div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="<?php echo pods_image_url(pods_field('right_image'), null); ?>" alt="..." /></div><?php endif; ?>
		</div>
	</div>
</header>
<?php endif; ?>
...
<?php else : ?>
	<section class="py-5"><div class="container px-5 my-5"><div class="entry-content"><?php the_content(); ?></div></div></section>
<?php endif; ?>
